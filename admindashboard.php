...
<head>
  ...
  <!-- 
    - primary meta tags
  -->
  <title>Voltax - Admin Dashboard</title>
          ...
          <div class="wrapper">
            ...
            <ul class="service-list" data-reveal="left">
              ...
              <li class="service-item">
                <div>
                  <h3 class="h5 card-title"><a href="addStation.html">Add New Station</a></h3>

                  <p class="card-text">
                    Can Add new stations easily from here.Just click on Link
                  </p>
                </div>
              ...
              <li class="service-item">
                <div>
                  <h3 class="h5 card-title"><a href="ViewOrDeleteStation.php">View/Delete Station</a></h3>

                  <p class="card-text">
                    Can View/Delete stations easily from here.Just click on Link
                  </p>
                </div>
              ...
              <li class="service-item">
                <div>
                  <h3 class="h5 card-title"><a href="updateStation.php">Update Station</a></h3>

                  <p class="card-text">
                     Can update stations easily from here.Just click on Link
                  </p>
                </div>
            ...
            <ul class="service-list" data-reveal="right">
              ...
              <li class="service-item">
                ...
                <div>
                  <h3 class="h5 card-title"><a href="viewbooking.php">View Booking</a></h3>
                  <p class="card-text">
                    Can view all the booking of the stations.
                  </p>
                </div>
              </li>
              ...
              <li class="service-item">
                ...
                <div>
                  <h3 class="h5 card-title"><a href="viewFeedback.php">View Feedback</a></h3>

                  <p class="card-text">
                    Can View the feedback given by the customer.
                  </p>
                </div>
              </li>
              ...
              <li class="service-item">
                ...
                <div>
                  <h3 class="h5 card-title"><a href="adminlogout.php">Log Out</a></h3>
