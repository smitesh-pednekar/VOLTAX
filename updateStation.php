...
<head>
  ...
  <!-- 
    - primary meta tags
  -->
  <title>Voltax - Update Station</title>
...
<section class="cta">
                ...
                <span class="title">Update Station</span>
  ...
  <?php
   ...
   $conn =connectdb();
	...
	if($result->num_rows>0)
	{
		...
		{	
		echo '<tr><form name="supdate" action="allactions.php" method="post">
			<td>'.$row["sno"].'</td>
			<input type="hidden" name="sno" value='.$row["sno"].'>
			<td><input type="text" name="sname" value='.$row["sname"].'></td>
			<td><input type="text" name="scity" value='.$row["scity"].'></td>
			<td><input type="text" name="sstate" value='.$row["sstate"].'></td>
			<td><input type="text" name="saddress" value='.$row["saddress"].'></td>
			<td><input type="text" name="smobile" value='.$row["smobile"].'></td>
			<td><input type="submit" name="btnupdate" value="Update"></form></td>
		   </tr>';
		}  
	}
?>
